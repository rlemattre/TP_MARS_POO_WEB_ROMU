 ...
 * @author romua
 */
public class ServletTraitement2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Traitement de la zone de saisie
            ...
            for (int i=0; i < inombreChiffre; i++) {
                ...
                double somme = 0;
                for (Double d : listeDesValeurs) {
                somme += d;
                }
                moyenne = somme/listeDesValeurs.size();
                
            }
            
            session.setAttribute("resultat", moyenne);
            
            session.setAttribute("valeurs",listeDesValeurs);
            
            RequestDispatcher rd = request.getRequestDispatcher("/resultatMoyenne.jsp");
